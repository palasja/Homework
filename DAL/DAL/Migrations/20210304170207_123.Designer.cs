            ...
            modelBuilder.Entity("DAL.ModelsDAL.Contract", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            EndDate = new DateTime(2021, 3, 4, 20, 2, 6, 897, DateTimeKind.Local).AddTicks(4499),
                            Number = "12-123/ВК6",
                            OrganizationId = 1,
                            SatartDate = new DateTime(2021, 3, 4, 20, 2, 6, 895, DateTimeKind.Local).AddTicks(5657)
                        },
                        new
                        {
                            Id = 2,
                            EndDate = new DateTime(2021, 3, 4, 20, 2, 6, 897, DateTimeKind.Local).AddTicks(5656),
                            Number = "12-1/ГК6",
                            OrganizationId = 2,
                            SatartDate = new DateTime(2021, 3, 4, 20, 2, 6, 897, DateTimeKind.Local).AddTicks(5642)
                        },
                        new
                        {
                            Id = 3,
                            EndDate = new DateTime(2021, 3, 4, 20, 2, 6, 897, DateTimeKind.Local).AddTicks(5679),
                            Number = "33-4/НК-6",
                            OrganizationId = 3,
                            SatartDate = new DateTime(2021, 3, 4, 20, 2, 6, 897, DateTimeKind.Local).AddTicks(5677)
                        },
                        new
                        {
                            Id = 4,
                            EndDate = new DateTime(2021, 3, 4, 20, 2, 6, 897, DateTimeKind.Local).AddTicks(5683),
                            Number = "4484/ОИ-6",
                            OrganizationId = 4,
                            SatartDate = new DateTime(2021, 3, 4, 20, 2, 6, 897, DateTimeKind.Local).AddTicks(5681)
                        });
                });
